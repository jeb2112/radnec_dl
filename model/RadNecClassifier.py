# classifier object specifies which model to train
# 1. pre-trained nnUNet encoder is paired with a dense layer for classification
# 2. a ResNet model is used
...
class RadNecClassifier(nn.Module):
    def __init__(
        self,
